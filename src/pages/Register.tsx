...
export default function Register() {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            setError(e.response?.data?.message || '注册失败，请稍后重试');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500">
            <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-8 w-full max-w-md mx-4 transform transition-all hover:scale-[1.02]">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 mt-2">加入我们，开始使用</p>
                </div>
                ...
                <div className="space-y-5">
                    ...
                    {/* Success Message */}
                    {showSuccess && (
                        <div className="bg-green-50 border border-green-200 text-green-600 px-4 py-3 rounded-xl text-sm flex items-center animate-pulse">
